<template>
  ...
  <div class="preview-buku-agenda-keluar-container">

    <!-- Header section displaying the title -->
    <div class="header">
      <h1>Preview Cetak Buku Agenda Surat keluar</h1> <!-- Displays a heading for the PDF preview -->
    </div>
...
export default {
  name: "PreviewBukuAgendakeluar", // The name of the component
...
.preview-buku-agenda-keluar-container {
